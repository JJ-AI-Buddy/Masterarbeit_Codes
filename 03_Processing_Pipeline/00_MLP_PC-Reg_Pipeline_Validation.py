...
path_model_weights = r"C:\Users\Johanna\OneDrive - bwedu\Masterarbeit_OSU\05_Data\Results\MLP_PC-Reg_02_bestmodel.pth"
path_validation = r"C:\Users\Johanna\OneDrive - bwedu\Masterarbeit_OSU\05_Data\Dataset_Validation\Urban\prepro"
path_plots = r"C:\Users\Johanna\OneDrive - bwedu\Masterarbeit_OSU\05_Data\Dataset_Validation\Urban\Plots"
path_GT_output = r"C:\Users\Johanna\OneDrive - bwedu\Masterarbeit_OSU\05_Data\Dataset_Validation\Urban\Labels_Urban_Validation.CSV"
path_results = r"C:\Users\Johanna\OneDrive - bwedu\Masterarbeit_OSU\05_Data\Dataset_Validation\Urban\Results\Val_Results_01_Urban_0-3_0-3_0-3.csv"
...
results = np.zeros((len(labels),48))
...
for index in range(0,len(labels)):
    ...
    label = np.ones((1,35))
    input_torch = torch.tensor(input_vec).float()
    ...
    results[index,4:39] = input_vec
    results[index,39:48] = prediction
