...
Notes: 
    - This script is a modified version of the original visualization script
    - Goal: Show the iteration step number in addition to the source and target point cloud during registration
    
    - Visualization does not work properly using the resources available in the Open3D library
    - Restart the kernel after every execution to improve the visualization resultj
    
    - !!! It is recommened to use Spyder as IDE because changes have to be made to the inputs before every execution !!!
"""
