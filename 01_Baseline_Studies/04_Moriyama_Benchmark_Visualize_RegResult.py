...
Notes: 
    - This script provides a visualization of only the final results of point cloud registration
    
    
    - !!! It is recommended to use Spyder as IDE because changes have to be made to the inputs before execution !!!
"""
