...
Notes:
    - This script provides plotting for the xy initial pose perturbation as 3D surface with the interactive Python Plotly library
    - Plot will be shown in the web browser after execution of this file and can then be saved locally
