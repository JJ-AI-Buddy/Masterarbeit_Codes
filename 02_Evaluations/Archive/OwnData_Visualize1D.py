...
file_name = "\C510_Rotl-ICP_01TRC.csv"       #File name must be given with a backslash in front: "\xxxx"
title = "Evaluation of 1D initial pose perturbation on TRC-Skidpad data\n - Timestamp ID: " + str(Idx_timestamp) + ", Axis ID: " + str(Idx_axis)
name = '1D_C510_' + str(Idx_timestamp) + '_' + str(Idx_axis) + '.pdf'

#######################################################################################################################

path_origin = r"C:\Users\Johanna\OneDrive - bwedu\Masterarbeit_OSU\Evaluations\01_TRC_Skidpad_Evaluation"
path = path_origin + file_name
path_plots = r"C:\Users\Johanna\OneDrive - bwedu\Masterarbeit_OSU\Evaluations\01_TRC_Skidpad_Evaluation\Plots1D_Python"
